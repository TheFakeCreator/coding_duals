...
export default function DuelArena() {
  ...
  useEffect(() => {
    const handleBeforeUnload = (e) => {
      e.preventDefault();
      e.returnValue = "Are you sure you want to leave the duel? It will be terminated.";
    };

    const handlePopState = () => {
      const confirmLeave = window.confirm("Are you sure you want to leave the duel? It will be terminated.");
      if (confirmLeave) {
        handleTerminateDuel();
      } else {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-4">
      ...
      <div className="mb-4 flex justify-between items-center">
        <div className="text-lg font-medium">⏱️ Time Left: {formatTime(timeLeft)}</div>
